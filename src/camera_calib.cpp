...
{
    cout << "[ INFO ]: 接收图像时间: " << img_msg->header.stamp.toSec() << std::endl;
    try
    {
        ...
        bool success = cv::findChessboardCorners(gray, cv::Size(CHECKERBOARD[0], CHECKERBOARD[1]), corner_pts, 
...
int main(int argc, char** argv)
{
    ...
    cv::Size imageSize(1280, 720); // 假设图像尺寸为640x480，根据实际图像尺寸修改
    ...
    {
        std::cerr << "Error: Not enough images for calibration." << std::endl;
    }
...
//     bool success;
//     int imageCount = 0;
//     const int numImages = 10; // 捕捉的图像数量
